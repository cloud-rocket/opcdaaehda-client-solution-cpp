...
#ifndef TECHNOSOFTWARE_WINDOWS1251ENCODING_H
#define TECHNOSOFTWARE_WINDOWS1251ENCODING_H
...
namespace Technosoftware
{
    namespace Base
    {
         ...
         *
         * @brief    Windows Codepage 1251 text encoding. Based on: http://msdn.microsoft.com/en-
         *             us/goglobal/cc305144.
         *
         * @ingroup BaseText
         */

        class TECHNOSOFTWARE_API Windows1251Encoding : public TextEncoding
        {
        public:
            Windows1251Encoding();
            ~Windows1251Encoding();
...
#endif /* TECHNOSOFTWARE_WINDOWS1251ENCODING_H */
