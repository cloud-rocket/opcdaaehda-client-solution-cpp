...
#ifndef TECHNOSOFTWARE_WINDOWS1252ENCODING_H
#define TECHNOSOFTWARE_WINDOWS1252ENCODING_H
...
namespace Technosoftware
{
    namespace Base
    {
         ...
         *
         * @brief    Windows Codepage 1252 text encoding.
         *
         * @ingroup BaseText
         */

        class TECHNOSOFTWARE_API Windows1252Encoding : public TextEncoding
        {
        public:
            Windows1252Encoding();
            ~Windows1252Encoding();
...
#endif /* TECHNOSOFTWARE_WINDOWS1252ENCODING_H */
