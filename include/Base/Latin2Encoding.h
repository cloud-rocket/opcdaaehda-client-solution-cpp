...
#ifndef TECHNOSOFTWARE_LATIN2ENCODING_H
#define TECHNOSOFTWARE_LATIN2ENCODING_H
...
namespace Technosoftware
{
    namespace Base
    {
         ...
         *
         * @brief    ISO Latin-2 (8859-2) text encoding.
         *             
        ...
        class TECHNOSOFTWARE_API Latin2Encoding : public TextEncoding
        {
        public:
            Latin2Encoding();
...
#endif /* TECHNOSOFTWARE_LATIN2ENCODING_H */
